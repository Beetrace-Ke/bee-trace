      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Welcome back, {firstName || 'Beekeeper'}</h1>
              <p className="text-gray-600 mt-1">Track your honey, manage investments, and earn carbon credits</p>
              {email && <p className="text-sm text-gray-500 mt-1">Email: {email}</p>}
              {phoneNumber && <p className="text-sm text-gray-500">Phone: {phoneNumber}</p>}
              {address && <p className="text-sm text-gray-500">Address: {address}</p>}
            </div>
